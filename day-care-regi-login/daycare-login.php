...
<head>
    ...
    <title>Day Care login form </title>
</head>
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-lg-12">
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" name="email" id="floating-day-email"
                                placeholder="Daycare Email Address">
                    ...
                    <div class="col-lg-12">
                        <div class="form-floating mb-3"><input type="password" class="form-control" name="password"
                                id="floating-day-pass" placeholder="Password">
