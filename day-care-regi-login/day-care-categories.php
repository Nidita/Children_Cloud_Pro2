                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <textarea name="toodler" value="<?php echo $toodlerErr;?>"id="foreigner-teaching" cols="30"
                                        rows="10"><?php echo $toodlerErr;?></textarea>
                                    <h6>Payment Per hour</h6>
                                    <textarea name="toodlerpay" value="<?php echo $toodlerpayErr;?>"id="payment-per-hour-school" cols="30"
                                        rows="10"><?php echo $toodlerpayErr;?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <textarea name="preschool" value="<?php echo $preschoolErr;?>"id="schooling-teaching" cols="30"
                                        rows="10"><?php echo $preschoolErr;?></textarea>
                                    <h6>Payment Per hour</h6>
                                    <textarea name="preschoolpay" value="<?php echo $preschoolpayErr;?>"id="payment-per-hour-preschool"
                                        cols="30" rows="10"><?php echo $preschoolpayErr;?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <textarea name="schoolage" value="<?php echo $schoolageErr;?>" id="advance-teaching" cols="30"
                                        rows="10"><?php echo $schoolageErr;?></textarea>
                                    <h6>Payment Per hour</h6>
                                    <textarea name="schoolagepay" value="<?php echo $schoolagepayErr;?>" id="payment-per-hour-school" cols="30"
                                        rows="10"><?php echo $schoolagepayErr;?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <textarea name="special" value="<?php echo $specialErr;?>"id="speical-teaching" cols="30"
                                        rows="10"><?php echo $specialErr;?></textarea>
                                    <h6>Payment Per hour</h6>
                                    <textarea name="specialpay" value="<?php echo $specialpayErr;?>"id="payment-per-hour-school" cols="30"
                                        rows="10"><?php echo $specialpayErr;?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFive" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <h6>Learning and entertainment in English language</h6>
                                    <textarea name="foreigner" value="<?php echo $foreignerErr;?>" id="foreigner-teaching" cols="30"
                                        rows="10"><?php echo $foreignerErr;?></textarea>
                                    <h6>Payment Per hour</h6>
                                    <textarea name="foreignerpay" value="<?php echo $foreignerpayErr;?>" id="payment-per-hour-school" cols="30"
                                        rows="10"><?php echo $foreignerpayErr;?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 mt-3">
                            <input type="submit" name="register"value="Sign Up" class="btn btn-primary w-100">
                        </div>
                    </div>
                </div>
